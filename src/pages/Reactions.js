...
const Reactions = () => {
  ...
  const balanceEquation = async (equation) => {
    try {
      const response = await axios.post('{process.env.BACKEND_API}/balance-equation', { reaction: equation });
  ...
  const splitReaction = async (backendBalancedEq) => {
    try {
      const response = await axios.post('{process.env.BACKEND_API}/split-reaction', { reaction: backendBalancedEq });
  ...
  const getDeltaCalculations = async (backendBalancedEq) => {
    ...
    try {
      const response = await axios.post('{process.env.BACKEND_API}/delta-calculations', { reaction: backendBalancedEq });
  ...
  const handleIceCalculation = async () => {
    try {
      const response = await axios.post('{process.env.BACKEND_API}/ice-calculator', {
  ...
  const handleBcaCalculation = async () => {
    try {
      const response = await axios.post('{process.env.BACKEND_API}/bca-calculator', {
        reaction: backendBalancedEq,
        RM: reactantValues,
        PM: productValues,
        volume: volume,
  ...
  const handleRedoxType = async (type) => {
    ...
    try {
      ...
      const response = await axios.post(`{process.env.BACKEND_API}/${endpoint}`, { reaction: equation });
