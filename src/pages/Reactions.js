...
const Reactions = () => {
  ...
  const balanceEquation = async (equation) => {
    try {
      const response = await axios.post('http://127.0.0.1:5000/balance-equation', { reaction: equation });
  ...
  const splitReaction = async (equation) => {
    try {
      const response = await axios.post('http://127.0.0.1:5000/split-reaction', { reaction: equation });
  ...
  const getDeltaCalculations = async (equation) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:5000/delta-calculations', { reaction: equation });
  ...
  const handleIceCalculation = async () => {
    try {
      const response = await axios.post('http://127.0.0.1:5000/ice-calculator', {
        reaction: equation,
        RM: reactantValues,
        PM: productValues,
        volume: volume,
  ...
  const handleBcaCalculation = async () => {
    try {
      const response = await axios.post('http://127.0.0.1:5000/bca-calculator', {
        reaction: equation,
        RM: reactantValues,
        PM: productValues,
        volume: volume,
  ...
  const handleRedoxType = async (type) => {
    ...
    try {
      ...
      const response = await axios.post(`http://127.0.0.1:5000/${endpoint}`, { reaction: equation });
