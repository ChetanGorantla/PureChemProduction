  ...
  const questionTopics = {
    ...
    "Laboratory Application": [
      ...
      },
      {
        ...
        hasSolution: true,
        hasSolutionImage: false,
        solutionText: "Recall that group 1 metals react violently with water to form Akali hydroxides (this can form explosions!), so our answer is A. Alternatively, we could have noticed that silver, gold,and copper are common metals used for coins and currency and so shouldn't cause any problems near water.",
        solutionImage: ""
      },
      {
        ...
        hasSolution: true,
        hasSolutionImage: false,
        solutionText: "Out of the four choices, the Ernelmeyer Flask works the best for mixing solutions. Although it may seem tempting to choose a Volumetric flask for this problem, we don’t need a precise volume of solution for this titration (since only the number of moles of permanganate matters).",
        solutionImage: ""
      },
      {
      ...
      },
      {
        ...
        hasSolution: true,
        hasSolutionImage: false,
        solutionText: "Let’s go through each of the reactions separately to see if there’s a formation of gas resulting from the reaction: Combustion of 1-propanol- Although one may not recognize the formula of 1-Propanol, we can still conclude the reaction would form carbon dioxide gas since this is a combustion reaction, so the answer is not A. Sublimation of dry-ice- By definition, sublimation is the process of a solid turning into a gas, so B is incorrect. Reaction between Sodium carbonate and hydroiodic acid- This acid-base reaction does the following: Na2CO3 + 2HI -> H2CO3 + 2NaI However, it is important to note that carbonic acid decomposes to form carbon dioxide and water, so C is incorrect for this reaction. Synthesis reaction between oxygen gas and potassium chloride- This simply forms an ionic compound with potassium as the cation, so our answer is D.",
        solutionImage: ""
      },
      {
