    ...
    try {
      ...
      if (selectedForm === 'ph') {
        if (selectedOption === 'Titrating weak acid with strong base' || selectedOption === 'titrating weak acid with strong base') {
          response = await axios.post('http://127.0.0.1:5000/calculate-ph-sbtwasig', {
            Ka: formDataPH.Ka,
            Ma: formDataPH.Ma,
            Mb: formDataPH.Mb,
            Vi: formDataPH.Vi,
          ...
          response = await axios.post('http://127.0.0.1:5000/calculate-ph-sbtsasig', {
          ...
          response = await axios.post('http://127.0.0.1:5000/calculate-ph-satwbsig', {
            Kb: formDataPH.Kb,
            Mb: formDataPH.Mb,
            Ma: formDataPH.Ma,
            Vi: formDataPH.Vi,
          ...
          response = await axios.post('http://127.0.0.1:5000/calculate-ph-satsbsig', {
            Ma: formDataPH.Ma,
            Mb: formDataPH.Mb,
  ...
  const handleMolaritySubmit = async (e) => {
    ...
    try {
      ...
      if (selectedForm === 'molarity') {
          ...
          response = await axios.post('http://127.0.0.1:5000/calculate-molarity', {
